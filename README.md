...
- Contextual tips for each risk level
...
> **Note:** To run the API project locally, replace `YOUR_API_KEY_HERE` in `api-weather/script.js` line 5 with your free API key from [openweathermap.org](https://openweathermap.org)
...
| Amber | `#E8A24B` | Primary accent, CTAs |
| Sage Green | `#7C9070` | Secondary accent, success states |
| Cream | `#F7F1E8` | Body text |
| Card | `#2B2520` | Card/surface backgrounds |
...
1. Clone the repo:
```bash
git clone https://github.com/Callmesuraj/paw-rescue-projects.git
```
...
[![GitHub](https://img.shields.io/badge/GitHub-Callmesuraj-black)](https://github.com/Callmesuraj)
